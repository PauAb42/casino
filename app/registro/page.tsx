...
export default function RegistroPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#05050A] text-white relative">
      <div className="fixed inset-0 bg-[url('/fondo.png')] bg-cover bg-center opacity-30 pointer-events-none"></div>
      
      <main className="flex-1 flex items-center justify-center w-full px-4 py-20 relative z-10">
        
        {/* Contenedor Principal Ancho (Calcado de imagen_3) */}
          ...
          <div className="w-full md:w-[55%] p-8 md:p-10">
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                {/* Sección 2: Información adicional (Adaptado a DB) */}
                <div>
